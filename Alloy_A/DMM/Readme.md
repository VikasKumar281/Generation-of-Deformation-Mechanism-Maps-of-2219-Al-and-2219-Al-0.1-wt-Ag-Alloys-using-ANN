...
This folder contains the Deformation Mechanism Maps (DMMs) generated for Alloy A (2219 Aluminium Alloy) using flow stress values predicted by the Artificial Neural Network (ANN) model.
...
3. The best ANN model (AA_08) was selected based on prediction accuracy.
